...
namespace Assets.Scripts
{
    public class Civilian : MonoBehaviour {
        ...
        private IEnumerator Evade()
        {
            ...
            var targetPosition = GuardUtil.CreateRandomWalkablePosition(transform.position, EvadeRadius, _grid);
            ...
            while (CivilianUtil.state == CivilianUtil.State.Evade)
            {
                ...
                if (_gridAgent.HasPathFinished)
                {
                    ...
                    {
                        // Generate waypoint
                        targetPosition = GuardUtil.CreateRandomWalkablePosition(transform.position, EvadeRadius, _grid);
